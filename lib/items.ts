...
export const items: Item[] = [
  ...
  { id: 12, en: 'Make friends easily',                          th: 'ฉันทำเพื่อนใหม่ได้ง่าย',                                                   factor: 'E', reverse: false },
  ...
  { id: 29, en: "Don't see things through",                     th: 'ฉันมักทำสิ่งต่างๆ ไม่สำเร็จจนถึงที่สุด',                                  factor: 'C', reverse: true  },
